...
All tests across `go-openapi` use our fork of `stretchr/jsonreference` (this repo): `github.com/go-openapi/jsonreference`.
...
<!-- links to references -->
[linter-config]: https://github.com/go-openapi/jsonreference/blob/master/.golangci.yml
[local-cliff-config]: https://github.com/go-openapi/jsonreference/blob/master/.cliff.toml
[remote-cliff-config]: https://github.com/go-openapi/ci-workflows/blob/master/.cliff.toml
[dependabot-config]: https://github.com/go-openapi/jsonreference/blob/master/.github/dependabot.yaml
...
[godoc-url]: https://pkg.go.dev/github.com/go-openapi/jsonreference
